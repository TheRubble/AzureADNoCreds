...
## Configure calling the api with postman
https://dev.to/425show/calling-an-azure-ad-secured-api-with-postman-22co

## Client Creds (API > API with shared secret)
https://learn.microsoft.com/en-us/azure/active-directory/develop/v2-oauth2-client-creds-grant-flow

## Pulumi baby
https://jimmybogard.com/securing-web-apis-with-azure-ad-building-the-server/
